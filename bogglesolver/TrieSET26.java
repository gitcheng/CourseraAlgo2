/*************************************************************************
 *  Compilation:  javac TrieSET26.java
 *  Execution:    java TrieSET26 < words.txt
 *  Dependencies: StdIn.java
 *
 *  An set for extended ASCII strings, implemented using a 26-way trie
 *  for the 26 English capital letters.
 *  COPIED from TrieSET.java
 * 
...
public class TrieSET26 implements Iterable<String> {
    ...
    /**
       charAt for the 26 capital English alphabets only
    **/
    private char charAt(String key, int d) {
        return (char) ((int) key.charAt(d) - 'A');
    }
    ...
    /**
     * Unit tests the <tt>TrieSET26</tt> data type.
     */
